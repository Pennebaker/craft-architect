...
return [
    ...
    'Field layout can only have 1 tab.' => 'Field layout can only have 1 tab.',
    ...
    'Type does not match existing type: "{fieldType}".' => 'Type does not match existing type: "{fieldType}".',
